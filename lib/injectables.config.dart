...
import 'domain/chatbot/i_chatbot_data_source.dart' as _i7;
import 'domain/chatbot/i_chatbot_facade.dart' as _i9;
import 'infrastructure/chatbot/chatbot_data_source_impl.dart' as _i8;
import 'infrastructure/chatbot/chatbot_facade_impl.dart' as _i10;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i6.Dio>(() => registerModule.getDio());
  gh.factory<_i7.IChatBotDataSource>(
      () => _i8.ChatBotDataSourceImpl(gh<_i6.Dio>()));
  gh.factory<_i9.IChatBotFacade>(
      () => _i10.ChatBotFacadeImpl(gh<_i7.IChatBotDataSource>()));
  gh.singleton<_i11.ThemeConfig>(_i11.ThemeConfig());
  gh.factory<_i12.ChatBotBloc>(
      () => _i12.ChatBotBloc(gh<_i9.IChatBotFacade>()));
  return getIt;
}
